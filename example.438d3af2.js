...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../src/splitter.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/Splitter.js":[function(require,module,exports) {
"use strict";
...
function Splitter(_ref) {
  ...
  var _useState = (0, _react.useState)(false),
      ...
      setResizing = _useState2[1]; // Children {width, height} array


  var _useState3 = (0, _react.useState)([]),
      _useState4 = _slicedToArray(_useState3, 2),
      sizes = _useState4[0],
      setSizes = _useState4[1]; // second pane flex basis css attrib
  // TODO: The value should be decreased by DIVIDER_SIZE / 2 pixels


  var _useState5 = (0, _react.useState)(size),
      _useState6 = _slicedToArray(_useState5, 2),
      flexBasis = _useState6[0],
      setFlexBasis = _useState6[1]; // container element


  var splitterElem = (0, _react.useRef)(null); // effects
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  function onDocMouseMove(evt) {
    if (resizing) {
      ...
      var _splitterElem$current = splitterElem.current.getBoundingClientRect(),
          x = _splitterElem$current.x,
          y = _splitterElem$current.y;
  ...
  function updateSizes() {
    var dividerPosition = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    if (!splitterElem || !splitterElem.current) return;
    var arr = [];
    var len = splitterElem.current.childNodes.length;
    if (len === 0) return;
    ...
    if (dividerPosition === null || len === 1) {
      for (var index = 0; index < len; index++) {
        var element = splitterElem.current.childNodes[index];
        arr.push({
      ...
      if (vertical) {
        var totalHeight = splitterElem.current.clientHeight;
        ...
        setFlexBasis("".concat(arr[2].height, "px"));
      } else {
        var totalWidth = splitterElem.current.clientWidth;
        ...
        setFlexBasis("".concat(arr[2].width, "px"));
      }
    }
  ...
  function wrapChildren() {
    ...
    var arrChildren = _react.default.Children.toArray(children);

    if (count > 0) {
      arr.push(_react.default.createElement(Pane, {
        key: "pane-0",
        vertical: vertical
      }, arrChildren[0]));
      ...
      if (count > 1) {
        // add divider
        var sty = {};
        if (vertical) sty.height = "".concat(DIVIDER_SIZE, "px");else sty.width = "".concat(DIVIDER_SIZE, "px");
        arr.push(_react.default.createElement("div", {
          ...
          style: sty
        }, _react.default.createElement("div", null))); // and set the second pane size via css flex-basis
  ...
  function render() {
    var wrappedChildren = wrapChildren();
...
},{"react":"../node_modules/react/index.js","./splitter.css":"../src/splitter.css"}],"../src/index.js":[function(require,module,exports) {
"use strict";
...
var _default = _Splitter.default;
exports.default = _default;
},{"./Splitter":"../src/Splitter.js"}],"example.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"example.js":[function(require,module,exports) {
"use strict";
...
var layouts = ["empty", "one", "horz", "vert", "nested", "deep_nested", "measured", "with_callback"];

function printSize(childSizes, idx) {
  if (childSizes && childSizes[idx]) return "".concat(childSizes[idx].width, "x").concat(childSizes[idx].height);
  return "-";
}
...
var components = {
  ...
  vert: function vert() {
    return _react.default.createElement(_index.default, {
      ...
      key: "up"
    }, "up"), _react.default.createElement("div", {
      key: "down"
    }, "down"));
  },
  ...
  deep_nested: function deep_nested() {
    return _react.default.createElement(_index.default, {
      key: "deep_nested"
    }, _react.default.createElement(_index.default, {
      key: "child",
      ...
      key: "up.up"
    }, "up.up"), _react.default.createElement("div", {
      key: "up.down"
    }, "up.down")), _react.default.createElement("div", {
      key: "down"
    }, "down")), _react.default.createElement("div", {
      key: "right"
    }, "right"));
  },
  measured: function measured() {
    return _react.default.createElement(_index.default, {
      size: "33%",
      key: "measured"
    }, _react.default.createElement("div", {
  ...
  with_callback: function with_callback(onResize, sizes) {
    return _react.default.createElement(_index.default, {
      size: "50%",
      key: "with_callback",
      onResize: onResize
    ...
    }, "left:", printSize(sizes, 0)), _react.default.createElement("h2", {
      key: "m_right",
      style: {
        padding: "20px"
      }
    }, "right:", printSize(sizes, 2)));
  }
};
...
function App() {
  var _useState = (0, _react.useState)(0),
      _useState2 = _slicedToArray(_useState, 2),
      activeLayoutIndex = _useState2[0],
      setActiveLayoutIndex = _useState2[1];

  var _useState3 = (0, _react.useState)(null),
      _useState4 = _slicedToArray(_useState3, 2),
      childSizes = _useState4[0],
      setChildSizes = _useState4[1];
  ...
  function onResize(sizes) {
    setChildSizes(_toConsumableArray(sizes));
  }

  function render() {
    var comp = components[layouts[activeLayoutIndex]];
    return _react.default.createElement("div", {
      className: "container"
    }, _react.default.createElement(Linkbar, {
      active: activeLayoutIndex,
      onChange: onLayoutChange
    }), _react.default.createElement("main", {
      className: "main"
    }, comp(onResize, childSizes)));
  }

  return render();
}

function Linkbar(_ref) {
  var onChange = _ref.onChange,
      active = _ref.active;

  function render() {
    var actions = layouts.map(function (layout, index) {
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","../src/index":"../src/index.js","./example.css":"example.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
